...
const RejectedOrderDetails = ({ selectedOrder, closeModal }) => {
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
              ...
              <div className="space-y-6">
                {/* Order Status Card */}
                <div className="bg-gradient-to-br from-red-50 to-red-100/50 border border-red-200 rounded-2xl p-6 transform hover:scale-[1.01] transition-transform duration-300">
            ...
            <div className="flex justify-end gap-4 mt-8 pt-6 border-t border-gray-200">
              ...
              <button
                ...
                className="px-6 py-3 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-xl hover:from-green-700 hover:to-green-800 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-[1.02] font-medium"
              >
                Process Refund
              </button>
            </div>
